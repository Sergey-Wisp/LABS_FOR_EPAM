...
public class Lab1 {
    private static void createAndShowGUI() {
        ...
        JLabel labelTip = new JLabel("Number of Fibone's");
        firstLine.add(labelTip);
        
        JTextField fileld = new JTextField(8);
        firstLine.add(fileld);
        
        JLabel labelResultMessage = new JLabel("values: ");
        ...
        JButton calcButton = new JButton("to count");
